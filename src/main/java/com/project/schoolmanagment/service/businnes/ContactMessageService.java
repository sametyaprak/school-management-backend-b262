...
import com.project.schoolmanagment.payload.mappers.ContactMessageMapper;
import com.project.schoolmanagment.payload.messages.SuccessMessages;
import com.project.schoolmanagment.payload.request.businnes.ContactMessageRequest;
import com.project.schoolmanagment.payload.request.businnes.ContactMessageUpdateRequest;
import com.project.schoolmanagment.payload.response.businnes.ContactMessageResponse;
import com.project.schoolmanagment.payload.response.businnes.ResponseMessage;
import com.project.schoolmanagment.repository.businnes.ContactMessageRepository;
...
public class ContactMessageService {
	...
	public ResponseMessage<ContactMessageResponse> save(ContactMessageRequest contactMessageRequest){
		...
		if(isSameMessageWithSameEmailForToday){
			throw new ConflictException(SuccessMessages.ALREADY_SEND_A_MESSAGE_TODAY);
		}
		...
		return ResponseMessage.<ContactMessageResponse>builder()
				...
				.returnBody(createContactMessage.contactMessageToResponse(savedData))
				.build();
	}
	...
	public List<ContactMessage>searchByDateBetween(String beginDateString, String endDateString){
		try {
			...
			throw new ConflictException(SuccessMessages.WRONG_DATE_FORMAT);
		}
	}
	...
	public String deleteById(Long id){
		...
		return SuccessMessages.CONTACT_MESSAGE_DELETED_SUCCESSFULLY;
	}
	...
	public List<ContactMessage>searchByTimeBetween(String startHourString, String startMinuteString,
		...
		try {
			...
			throw new ConflictException(SuccessMessages.WRONG_TIME_FORMAT);
		}
	}

	public ContactMessage getContactMessageById(Long id){
		return contactMessageRepository.findById(id).orElseThrow(
				()-> new ResourceNotFoundException(SuccessMessages.NOT_FOUND_MESSAGE));
	...
	public ResponseMessage<ContactMessageResponse> updateById(Long id, ContactMessageUpdateRequest contactMessageUpdateRequest){
		...
		return ResponseMessage.<ContactMessageResponse>builder()
				.message("Contact Message Created Successfully")
				.httpStatus(HttpStatus.CREATED)
				.returnBody(createContactMessage.contactMessageToResponse(contactMessage))
				.build();
	}
